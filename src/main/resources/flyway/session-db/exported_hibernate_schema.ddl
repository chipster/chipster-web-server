;              
CREATE USER IF NOT EXISTS SA SALT '8766e0080405b25e' HASH 'c05ffc496b9c52613c78b00aca768c9e56963a876ad965df69724e776a837139' ADMIN;            
...
CREATE MEMORY TABLE PUBLIC.DATASETTOKEN(
...
CREATE MEMORY TABLE PUBLIC.INPUT(
...
CREATE MEMORY TABLE PUBLIC.JOB(
    JOBID UUID NOT NULL,
    CREATED TIMESTAMP,
...
CREATE MEMORY TABLE PUBLIC.METADATAENTRY(
...
CREATE MEMORY TABLE PUBLIC.PARAMETER(
    DBID INTEGER NOT NULL,
    DESCRIPTION CLOB,
    DISPLAYNAME VARCHAR(255),
...
CREATE MEMORY TABLE PUBLIC.RULE(
