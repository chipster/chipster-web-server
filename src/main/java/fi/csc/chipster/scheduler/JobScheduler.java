...
public class JobScheduler implements SessionEventListener, MessageHandler.Whole<String>, StatusSource {
	...
	public JobScheduler(Config config) {
		this.config = config;
	}

    public JobScheduler(ServiceLocatorClient serviceLocator, AuthenticationClient authService,
	...
	public void startServer() throws ServletException, DeploymentException, InterruptedException, RestException, IOException {
    	...
    	logger.info("job scheduler is up and running");    		
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        JobScheduler server = new JobScheduler(new Config());
    	try {
    		server.startServer();
    	} catch (Exception e) {
