...
public interface JobFactory {
	...
	/**
	 * Creates job object using the tool description and job message, i.e.,
	 * instantiates the comp
	 * job described by the description and parameterised by the parameters
	 * contained in job message.
	 * 
	 * @param dbJob
	 * @param runtime
	 * @param config
