...
public class ServiceLocator {
	...
	public void startServer() throws IOException {
		...
		// servers need to get the internal services with username and password to find
		// the auth address and get a token
		...
		this.adminServer = RestUtils.startAdminServer(Role.SERVICE_LOCATOR, config, authService, client,
