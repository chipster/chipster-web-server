...
public class RestFileBrokerClient implements FileBrokerClient {
	...
	public RestFileBrokerClient(SessionDbClient sessionDbClient2, String restProxy, AuthenticationClient authClient, SessionManager sessionManager) {
	...
	public RestFileBrokerClient(SessionDbClient sessionDbClient2, ServiceLocatorClient serviceLocator, AuthenticationClient authClient) {
		this.sessionDbClient = sessionDbClient2;
