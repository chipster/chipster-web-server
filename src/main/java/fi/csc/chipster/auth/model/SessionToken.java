 ...
 * for example to create a session download url. Scheduler creates read-write tokens
 * for jobs so that those can download the input data, update the job object and finally
