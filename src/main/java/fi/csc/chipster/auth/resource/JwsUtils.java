...
private static Logger logger = LogManager.getLogger();
	...
	public static KeyPair getOrGenerateKeyPair(Config config, String role, SignatureAlgorithm signatureAlgorithm) throws PEMException {
		...
		logger.info(role + "jws private key:" + keyPair.getPrivate().getAlgorithm() + " " + keyPair.getPrivate().getFormat());
		logger.info(role + "jws public key:" + keyPair.getPublic().getAlgorithm() + " " + keyPair.getPublic().getFormat());
