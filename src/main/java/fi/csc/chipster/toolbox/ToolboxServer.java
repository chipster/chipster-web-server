...
//
// public class ToolboxServer extends MonitoredNodeBase implements
// MessagingListener, ShutdownCallback {
//
...
//
// // get configs
// DirectoryLayout.initialiseServerLayout(Arrays.asList(new String[] { "toolbox"
// }), configURL);
...
// MessagingTopic compTopic = endpoint.createTopic(Topics.Name.TOOLBOX_TOPIC,
// AccessMode.READ);
...
// // source code request
// else if
// (CommandMessage.COMMAND_GET_SOURCE.equals(commandMessage.getCommand())) {
...
// else {
// logger.warn("expecting a command message, got something else: " +
// chipsterMessage.getMessageID() + " "
...
//
// for (ModuleDescriptionMessage descriptionMessage :
// toolboxRestService.getToolbox().getModuleDescriptions()) {
// descriptionMessage.setReplyTo(requestMessage.getReplyTo());
// logger.info("sending descriptions for module " +
// descriptionMessage.getModuleName());
...
// */
// private void sendReplyMessage(final ChipsterMessage original, final
