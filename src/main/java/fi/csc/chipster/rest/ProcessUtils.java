...
public class ProcessUtils {
	...
	public static void run(File stdinFile, File stdoutFile, String... cmdArray)
			throws IOException, InterruptedException {
		run(stdinFile, stdoutFile, null, false, cmdArray);
	}

	public static void run(File stdinFile, File stdoutFile, Map<String, String> env, boolean printStdout,
			String... cmdArray) throws IOException, InterruptedException {
		...
		if (stdoutFile != null) {
			...
			if (!printStdout) {
				// stdout has to but somewhere, otherwise the process stops when the buffer is
				// full
		...
		if (stdinFile != null) {
			...
			try (OutputStream processStdin = process.getOutputStream()) {
				copyWithProgressLogging(new FileInputStream(stdinFile), processStdin, command + " progress: ",
						stdinFile.length());
			}
		}
	...
	private static void copyWithProgressLogging(InputStream in, OutputStream out, String message, long totalSize)
			throws IOException {
	...
	public static String runStdoutToString(File stdinFile, String... cmdArray)
			throws IOException, InterruptedException {
