 ...
 * 
 * The code is easier to read when the collection of files is separated from
 * technicalities of
 * the zip packaging, but we can't simply pass a list of InputStreams for two
 * reasons: first, there is
 * a need for a few extra information like name and compression level and
 * second, the input stream
