...
// Exception exception = hibernate.runInTransaction(new
// HibernateRunnable<Exception>() {
...
// public void createTokenFromOidc2(OidcProvidersMock oidcProviderMock,
// OidcResource resource) throws JOSEException,
// GeneralSecurityException, IOException, ParseException, URISyntaxException,
...
// assertEquals(PREFIX3, new
// UserId(parseChipsterToken(chipsterToken).get("sub").toString()).getAuth());
...
// // missing required claim (issuer1 is configured to require
// REQUIRE_CLAIM_KEY1)
// try {
// HashMap<String, Object> claims2 = new HashMap<>(claimsIssuer1) {
// {
...
// // wrong key
// try {
// String jws2 = oidcProviderMock.getIdToken(privateKey2, claimsIssuer3,
// JWSAlgorithm.RS256);
// resource.createTokenFromOidc(jws2, null);
// Assertions.fail();
// } catch (ForbiddenException e) {
...
// try {
// String jws2 = getIdTokenSymmetric(oidcProviderMock.toString(), claimsIssuer3,
// JWSAlgorithm.HS256);
// resource.createTokenFromOidc(jws2, null);
// Assertions.fail();
// } catch (ForbiddenException e) {
...
// // oidc1 and oidc2 have same issuer and clientId, but different required
// claim
...
// */
// private String getIdTokenSymmetric(String key, HashMap<String, Object>
// claims, JWSAlgorithm algorithm)
