...
public class RuleResourceTest {
	...
	public static void setUp() throws Exception {
		...
		exampleSessionOwnerClient = new SessionDbClient(
				...
				new AuthenticationClient(launcher.getServiceLocator(), "jaas/example_session_owner",
						"example_session_owner", Role.CLIENT).getCredentials(),
				Role.CLIENT);
	}
	...
	public void putErrors() throws IOException, RestException {
		...
		// check that client can't change any of these (server doesn't produce errors
