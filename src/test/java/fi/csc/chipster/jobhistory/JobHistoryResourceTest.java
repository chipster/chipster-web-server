...
public class JobHistoryResourceTest {
	...
	public static void setUp() throws Exception {
		...
		sessionID = sessionDBClient1
				.createSession(RestUtils.getRandomSession());
	}
	...
	public void testSaveJobDbPerformance() throws InterruptedException,
		...
		assertEquals(true, jobHistoryClient2.getJobHistoryList().size() > 1000);
	}*/
	...
	public void inserTestJobs() throws InterruptedException, RestException {
		...
		for (int i = 0; i < MAX_NUM; i++) {
			...
			j.setEndTime(jobStartTime.plus(1, ChronoUnit.HOURS));
