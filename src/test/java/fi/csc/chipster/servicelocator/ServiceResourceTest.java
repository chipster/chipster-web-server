...
public class ServiceResourceTest {
	...
	public void getWithSessionDbTokens() throws IOException, RestException {
		...
		SessionDbClient user1Client = new SessionDbClient(launcher.getServiceLocator(), launcher.getUser1Token(),
				Role.CLIENT);
		SessionDbClient schedulerClient = new SessionDbClient(launcher.getServiceLocatorForScheduler(),
				launcher.getSchedulerToken(), Role.SERVER);
